...
import 'package:mad_final_paper/pages/features/app/notification_box.dart';

import 'features/app/user_auth/firebase_auth_services.dart';

class signUpPageConfiguration extends StatefulWidget {
  const signUpPageConfiguration({super.key});

  @override
  State<signUpPageConfiguration> createState() =>
      _signUpPageConfigurationState();
}

class _signUpPageConfigurationState extends State<signUpPageConfiguration> {
  ...
  Color user_name_label = Colors.black54;
  var _inputText = '';
                      ...
                      onChanged: (text) {
                        setState(() {
                          ...
                          if (_inputText.isNotEmpty) {
                            user_name_label = Colors.black54;
                          } else {
                            user_name_label = Colors.black54;
                          }
                        });
  ...
  void _signUp()async{
    ...
    if(user != null){
      messageToShow('User is successfully created!');
    }
    else{
